...
# bind_chained('ttt', 'set-cmd-text -s :tab-select', 'tab-give')
...
config.bind(',s', 'set-cmd-text -s :screenshot')
...
config.bind('A', 'set-cmd-text -s :bookmark-add -t {url}')
...
config.bind(
    'ay', 'hint links spawn kitty --directory=~/Downloads/ yt-dlp {hint-url}')
config.bind('ac', 'download-cancel')
config.bind('a!', 'download-clear')
config.bind('Dd', 'download')
config.bind('Dp', 'set-cmd-text -s :print --pdf')
# bind_chained('Dg', 'jseval -f ~/.config/qutebrowser/userscripts/download-protected-pdf.js',
#                   'spawn --userscript convert-to-pdf')
config.bind(
    'Dg', 'jseval -f ~/.config/qutebrowser/userscripts/download-protected-pdf.js')
...
config.bind('ca', 'set-cmd-text -s :spawn --userscript container-add')
config.bind('cr', 'set-cmd-text -s :spawn --userscript container-rm')
...
config.bind('wt', 'set-cmd-text -s :tab-give')
config.bind('wT', 'set-cmd-text -s :tab-take')
# bind_chained('wbb', 'set-cmd-text -s :tab-select', 'tab-give')
# bind_chained('wbB', 'set-cmd-text -s :tab-select', 'tab-take')
...
config.bind(
    'Xd', 'hint links spawn kitty --directory=~/Downloads/ yt-dlp {hint-url}')
...
config.bind(
    'ya', 'mode-enter caret;;selection-toggle;;move-to-end-of-document;;yank selection;;mode-leave')
