...
config.bind("tbw", "cmd-set-text -s :open -t -w br")
config.bind("tbp", "cmd-set-text -s :open -t -p br")
config.bind("Tbn", "cmd-set-text -s :open -t br {url:pretty}")
config.bind("Tb", "cmd-set-text -s :open -t -r br {url:pretty}")
config.bind("Tbw", "cmd-set-text -s :open -t -w br {url:pretty}")
config.bind("Tbp", "cmd-set-text -s :open -t -p br {url:pretty}")
config.bind("u", "undo")
