...
function show_menu()
    ...
    mp.add_forced_key_binding("ctrl+UP", "increase_boundaries", function() increase_boundaries() end,
        { repeatable = true })
    mp.add_forced_key_binding("ctrl+DOWN", "decrease_boundaries", function() decrease_boundaries() end,
        { repeatable = true })
