...
west build -b nice_nano_v2 -d build/left -- -DSHIELD="corne_left" -DZMK_CONFIG="$HOME/.config/zmk/corne/config"
west build -b nice_nano_v2 -d build/right -- -DSHIELD="corne_right" -DZMK_CONFIG="$HOME/.config/zmk/corne/config"
